    ...
    public partial class createDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectModelTeacherModel", x => new { x.SubjectsId, x.TeachersId });
                    table.ForeignKey(
                        name: "FK_SubjectModelTeacherModel_Subjects_SubjectsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Homeworkss", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Homeworkss_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Homeworkss_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Homeworkss_Teachers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HomeworkSubmissions_Homeworkss_HomeworkId",
                        column: x => x.HomeworkId,
                        principalTable: "Homeworkss",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Homeworkss_GroupId",
                table: "Homeworkss",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Homeworkss_SubjectId",
                table: "Homeworkss",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Homeworkss_TeacherId",
                table: "Homeworkss",
                column: "TeacherId");
