...
namespace school_management_system.Migrations
{
    ...
    public partial class updateDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TimetableModelId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Classrooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Classrooms_Timetables_TimetableModelId",
                        column: x => x.TimetableModelId,
                        principalTable: "Timetables",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "SubjectModelTimetableModel",
                columns: table => new
                {
                    SubjectsId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectModelTimetableModel", x => new { x.SubjectsId, x.TimetablesId });
                    table.ForeignKey(
                        name: "FK_SubjectModelTimetableModel_Subjects_SubjectsId",
                        column: x => x.SubjectsId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubjectModelTimetableModel_Timetables_TimetablesId",
            ...
            migrationBuilder.CreateTable(
                name: "TeacherModelTimetableModel",
                columns: table => new
                {
                    TeachersId = table.Column<int>(type: "int", nullable: false),
                    TimetablesId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherModelTimetableModel", x => new { x.TeachersId, x.TimetablesId });
                    table.ForeignKey(
                        name: "FK_TeacherModelTimetableModel_Teachers_TeachersId",
                        column: x => x.TeachersId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeacherModelTimetableModel_Timetables_TimetablesId",
                        column: x => x.TimetablesId,
                        principalTable: "Timetables",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Classrooms_TimetableModelId",
                table: "Classrooms",
                column: "TimetableModelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubjectModelTimetableModel_TimetablesId",
                table: "SubjectModelTimetableModel",
                column: "TimetablesId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherModelTimetableModel_TimetablesId",
                table: "TeacherModelTimetableModel",
                column: "TimetablesId");
        }
